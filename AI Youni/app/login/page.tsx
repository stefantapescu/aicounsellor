...
import { Apple, Eye, EyeOff, Mail, Lock, LogIn } from "lucide-react"
...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-[url('/placeholder.svg?height=1080&width=1920')] bg-cover bg-center">
        ...
        <div className="w-full max-w-md lg:w-1/2">
          <div className="relative overflow-hidden rounded-xl bg-gray-900/80 p-6 shadow-xl backdrop-blur-sm md:p-8">
            <div className="absolute -right-6 -top-6 opacity-20">
              <RoboYouniMascot width={100} height={100} />
            </div>
