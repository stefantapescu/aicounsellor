"use client" // Add "use client" if needed for state hooks (like showPassword)

import type React from "react" // Add React import
import { useState } from "react" // Add useState import
import Link from 'next/link';
import { Apple, Eye, EyeOff, Mail, Lock, LogIn } from "lucide-react" // Add lucide icons
...
// Keep existing OAuthButton helper, but we'll style its usage later
...
export default function LoginPage() {
  ...
  // Remove email/password state as we use server actions
    ...
    >
      ...
      <div className="container relative z-10 flex flex-col items-center px-4 md:px-6 lg:flex-row lg:items-stretch lg:gap-8">
        ...
        <div className="mb-8 text-center text-white lg:mb-0 lg:flex lg:w-1/2 lg:flex-col lg:justify-center lg:text-left">
          <h1 className="mb-2 text-3xl font-bold md:text-4xl">Welcome back to AI Youni</h1>
          <p className="text-lg text-gray-300">Log in to continue your educational journey</p>
        </div>
        ...
        <div className="w-full max-w-md lg:w-1/2">
          <div className="relative overflow-hidden rounded-xl bg-gray-900/80 p-6 shadow-xl backdrop-blur-sm md:p-8">
            {/* Keep existing mascot placement from original code */}
            <div className="absolute -right-4 -bottom-4 opacity-50 lg:opacity-100">
               <RoboYouniMascot width={80} height={80} />
            </div>

            <h2 className="mb-6 text-2xl font-bold text-white">Log In</h2>
            ...
            <form className="space-y-4">
              <div className="space-y-2">
                <div className="relative">
                  ...
                  {/* Use shadcn Input, but keep name="email" for server action */}
                  <Input
                    id="email"
                    type="email"
              ...
              <div className="space-y-2">
                <div className="relative">
                  ...
                  <button
                    ...
                    aria-label={showPassword ? "Hide password" : "Show password"} // Add aria-label
                  >
                    {showPassword ? <EyeOff className="h-5 w-5" /> : <Eye className="h-5 w-5" />}
                  </button>
                </div>
                <div className="text-right">
                  {/* Use v0 styling for forgot password link */}
              ...
              {/* Keep existing login button with formAction */}
              <Button
                formAction={login}
            ...
            <div className="grid gap-3">
               {/* Apply v0 styles to the existing OAuthButton component usage */}
               <OAuthButton
                 provider="google"
